...
class View extends \Gcms\View
{
    ...
    public function render($index)
    {
        ...
        $table = $fieldset->add('groups', array(
            ...
            'comment' => '{LNG_Determine how to calculate the surcharge in case of non-payment as specified, for example, fill in 5 and * 0.5 means more than 5 days, accounted for half a month, and 20 * 1 means more than 20 days, accounted for 1 month, etc.}',
        ));
        $row = $table->add('row');
        // excess_interest1
        $row->add('text', array(
